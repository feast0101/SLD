...
function drawVisualization2() {
	...
	chart1 = new google.visualization.ChartWrapper({
		...
		'containerId' : 'chart1',
		'options' : {
			title : 'Weekly Trend line for each service usage by Tenant',
			'hAxis' : {
				title : 'Week',
				'format': "EE",
				'slantedText' : false
	...
	var chart2 = new google.visualization.ChartWrapper({
		...
		'options' : {
		    'tooltip': { 'isHtml': true },
			'isStacked' : true,
			title : 'Weekly Application Service Usage Breakup by Tenant',
			'hAxis' : {
				title : 'Week',
				'format': "EE",
				'slantedText' : false
...
<body>
 ...
 ${noDataErrorMessage}
	<div id="dashboard2">
		...
		<br> <br>
		<br> <br>
		<div id="control3" style='width: 915px; height: 50px; display: none;'></div>
	</div>
